...
let project = Project.framework(
    ...
    dependencies: [
        ...
        .project(target: "RegisterBusinessPresentation", path: .relativeToFeature("RegisterBusiness")),
        .project(target: "RegisterBusinessDomain", path: .relativeToFeature("RegisterBusiness")),
        ...
        .project(target: "StoreInfoPresentation", path: .relativeToFeature("StoreInfo")),
        .project(target: "StoreInfoDomain", path: "StoreInfo")
    ]
)
